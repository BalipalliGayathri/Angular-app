(function($) {
    ...
    $(function() {
        ...
        if ($("#revenueCircle3").length) {
            ...
            bar.text.style.fontSize = '1.5rem';
            bar.animate(.73); // Number from 0.0 to 1.0
        }
        if ($("#revenueCircle4").length) {
            var bar = new ProgressBar.Circle(revenueCircle4, {
                color: '#000',
                // This has to be the same size as the maximum width to
                // prevent clipping
                strokeWidth: 16,
            ...
            bar.text.style.fontSize = '1.5rem';
            bar.animate(.83); // Number from 0.0 to 1.0
        }
        if ($("#revenueCircle5").length) {
            var bar = new ProgressBar.Circle(revenueCircle5, {
                color: '#000',
                // This has to be the same size as the maximum width to
                // prevent clipping
                strokeWidth: 16,
            ...
            bar.text.style.fontSize = '1.5rem';
            bar.animate(.53); // Number from 0.0 to 1.0
        }
